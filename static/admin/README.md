...
|----------------|-------------------------------|-----------------------------|
|`title`           |blog title                 |optional but required                  |
|`description`     |Description           |optional but required             |
|`author`          |Blog Author| optional but required |
|`date`    |Blog publish date            |automatically generated            |
|`image`   |an image upload widget            |optional but required            |
...
|  Field         |Description               |Note                         |
|----------------|-------------------------------|-----------------------------|
|`layout`           |blog layout HTML markup             |required                   |
